# Contributing to IDCDownloader

There are many ways to contribute to IDCDownloader.

- Submit a feature request or bug, or add to the discussion on the [IDCDownloader issue tracker][is]
- Submit a [Pull Request][pr] to improve IDCDownloader.

## The PR Process, and Related Gotchas

### How to submit a PR ?

If you are new to IDCDownloader development and you don't have push access to the IDCDownloader
...
When submitting a PR, make sure to add a `Cc: @IDCDownloader/developers` comment to
notify IDCDownloader developers of your awesome contributions. Based on the
...
- You do NOT have push access: A IDCDownloader core developer will integrate your PR.
...
[pr]: https://github.com/Sunderlandkyl/IDCDownloader/merge_requests
[is]: https://github.com/Sunderlandkyl/IDCDownloader/issues
